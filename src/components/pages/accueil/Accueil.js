        ...
        <div className="container accueil">
            <div className="row">
                <div className="col l8 m12 offset-l2 main-frame">
                    ...
                    <animated.p className="flow-text bio position-relative" style={enterPageP}>Bonjour, je suis étudiant au Samsung Campus où j'apprends le développement web. Curieux, j'aime découvrir et apprendre de nouvelles technologies.</animated.p>
